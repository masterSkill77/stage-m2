<div style="background-color: #f2f2f2; padding: 20px;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 20px; border-radius: 5px; box-shadow: 0px 3px 15px rgba(0,0,0,0.2);">
      ...
      <p style="font-size: 18px; line-height: 1.5;"><span>To see your newly item, <a href="<?= env("URL_CLIENT") . '/profile/paiement/' . $auction->auction_uuid ?>">check out here</a></span></p>
    </div>
  </div>
</div>
</div>